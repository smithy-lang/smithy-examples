...
public class ResourceMetadataTraitValidatorTest {
    ...
    public void dectectsViolationModel() {
        ValidatedResult<Model> validatedResult = Model.assembler()
            ...
            .addImport(getClass().getResource("resource-metadata-validator-test.smithy"))
            .assemble();
        ...
        assertEquals(validationEvent.getShapeId().get(), ShapeId.from("io.smithy.example.test#TestResource"));
    }
}
