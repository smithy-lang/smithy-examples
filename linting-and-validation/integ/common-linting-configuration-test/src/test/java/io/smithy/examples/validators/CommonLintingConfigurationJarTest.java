...
public class CommonLintingConfigurationJarTest {
    ...
    public void checkJarManifest() {
        ...
        assertThat(Arrays.asList(tagValues), hasItems(
            "common-config",
            "linting-and-validation-example",
            "linting-and-validation-example:common-linting-configuration",
            "linting-and-validation-example:common-linting-configuration:unspecified",
            "validators"
        ));
    }
